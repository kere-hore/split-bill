...
import { z } from "zod";
import { withCache, CacheTTL } from "@/shared/lib/cache-strategy";
import {
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Use cache for settlements list
    const cacheKey = `settlements:${userId}:${page}:${limit}:${status}`;
